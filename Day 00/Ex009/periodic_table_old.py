...
def ler_tabela():
    ...
    for var in dadostabela:
        if var:
            ...
            element = Elemento(nomeelemento[0], posicaoelemento[1], numeroelemento[1], siglaelemento[1], molelemento[1],eletronelemento[1])
    ...
    for obj in lista_elementos:
        ...
        while contador < 18:
            if contador == int(obj.posicao):
                inserirlinha = "<td style=\"border: 1px solid black; padding:10px\"><h4>" + obj.elemento + "</h4></ul><li>No " + obj.numero + "</li><li>" + obj.sigla + "</li><li>" + obj.mol + "</li><li>" + obj.eletron + " electron</li></ul></td>"
